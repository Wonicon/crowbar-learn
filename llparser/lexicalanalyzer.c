...
get_token(Token *token)
{
    ...
    while (st_line[st_line_pos] != '\0') {
        ...
        // Since we do not assign states for matching operators,
        // they are all expected to be under INITIAL_STATUS
        // and then found and returned directly.
        ...
        if (isdigit(current_char)) {
            ...
            assert(status == IN_INT_PART_STATUS || status == IN_FRAC_PART_STATUS);
